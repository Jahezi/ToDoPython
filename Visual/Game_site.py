...
ui.run() label = ui.label(datetime.now().strftime('%Y-%m-%d %H:%M:%S')).style('font-size: 18px; font-weight: bold;')
        ui.timer(1, lambda: update_time(time_label))
